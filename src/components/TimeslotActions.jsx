    ...
    <Menu as="div" className="inline-block text-left">
      <Menu.Button
        className="inline-flex w-full justify-center
          rounded-md bg-gray-800 bg-opacity-30 px-4 py-2 text-sm
          font-medium text-gray-300 hover:bg-opacity-50 focus:outline-none
      ...
      <Menu.Items
        className="absolute right-0 mt-2 w-56 origin-top-right
          divide-y divide-gray-100 rounded-md bg-gray-900 shadow-md 
          ring-1 ring-gray-700 ring-opacity-75 focus:outline-none"
      >
        {!slot.completed && (
          <Menu.Item>
            {({ active }) => (
