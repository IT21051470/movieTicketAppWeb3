...
const TimeSlotList = ({ slots }) => {
  ...
  return (
    <div className="flex flex-col items-center mb-10 w-full sm:w-3/6 mx-auto bg-gray-800 text-white rounded-lg p-4">
      ...
      {slots.length > 0 ? (
        <ul className="space-y-4 w-full">
          {slots.map((slot, i) => (
            <li
              key={i}
              className="bg-gray-600 p-4 rounded-md w-full flex justify-between items-center"
            >
              <div>
